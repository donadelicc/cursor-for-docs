...
import PilotAccessDenied from '@/auth/PilotAccessDenied';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-blue-600 to-blue-800">
        <div className="w-full max-w-md">
          ...
          {isForgotPassword ? (
            ...
            <form onSubmit={handlePasswordReset} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-white rounded-lg focus:ring-2 focus:ring-white focus:border-white transition-colors bg-white text-gray-900"
              ...
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {loading ? (
            ...
            <div>
              {/* Google Login Button - Now at the top */}
              <button
                onClick={handleGoogleLogin}
                disabled={loading}
                className="w-full flex justify-center items-center py-3 px-4 border border-white rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                ...
                {!isSignUp && (
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-sm text-white hover:text-blue-100 font-medium underline"
                    >
                      Forgot password?
                    </button>
                  </div>
