...
export default function HeroSection() {
  ...
  const fullText = "This warming trend is primarily attributed to human activities, particularly the burning of fossil fuels.";
      ...
      <div className="relative h-full flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-lg aspect-square rounded-2xl shadow-xl flex items-center justify-center backdrop-blur-sm border border-gray-700/30 overflow-hidden"
              ...
              <div className="w-full h-full p-6 flex flex-col">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#29a7ac' }}></div>
                    <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#2b7ab0' }}></div>
                    <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#513fbd' }}></div>
                  </div>
                ...
                <div className="flex-1 bg-white/10 rounded-lg p-6 font-sans text-sm text-gray-300 overflow-hidden">
                  <div className="space-y-3">
                    ...
                    <div className="min-h-[120px]">
                      ...
                      <div className="text-gray-300 leading-relaxed">
                        Recent studies indicate that global temperatures keeps rising at a steady growth rate.
                      </div>
                      ...
                      {showSuggestion && (
                        <div className="p-4 rounded-lg border-l-4 border-teal-500/50 bg-teal-500/10 animate-slide-up">
                          <div className="flex items-start space-x-3">
                            <div className="w-2 h-2 rounded-full mt-2 animate-pulse" style={{ backgroundColor: '#29a7ac' }}></div>
                            <div className="flex-1">
                              <div className="text-xs font-medium text-teal-400 mb-2">AI Assistant</div>
                              <div className="text-sm text-gray-300">
                                <span className="text-teal-400">💡 Suggestion:</span> Consider adding data from your uploaded IPCC report. 
                                <br />
                                <span className="text-gray-400 italic">"Global temperatures have risen by 1.1°C since pre-industrial levels..."</span>
                                <br />
                                <span className="text-blue-400 text-xs cursor-pointer hover:text-blue-300 transition-colors">📚 View in source: IPCC Report 2023</span>
                              </div>
                            </div>
                          </div>
                        </div>
